<template>
  <section>
    <PageHeader title="Sale buildings" subtitle="Property groupings for apartment sales.">
      <template #actions>
        <button type="button" class="btn-primary w-full sm:w-auto" @click="openCreate">Add building</button>
      </template>
    </PageHeader>

    <ResponsiveDataList :items="buildings" :columns="columns" empty-message="No sale buildings yet.">
